...
const HomepageSingleBannerTwo: React.FC<Props> = (props) => {
        ...
        <div className="mb-[25px]">
          ...
          <div>
            <picture>
              <img
                id="preview-img"
                className="admin-img border border-[#ddd] p-0 m-0 w-[200px]  h-[28px] object-cover"
                src={ad?.adImage}
                alt=""
              />
            </picture>
...
export default HomepageSingleBannerTwo;
